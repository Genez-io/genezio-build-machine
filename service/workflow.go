...
type WorkflowService interface {
	...
	S3Workflow(token, S3URL string, projectName, region, basePath *string) string
...
func (w *workflowService) S3Workflow(token string, S3URL string, projectName, region, basePath *string) string {
